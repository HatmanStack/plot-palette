    ...
    try:
        ...
        try:
            ...
            logger.error(json.dumps({
                "event": "query_user_templates_error",
                "error": str(e)
            }))
        ...
        if include_public:
            try:
                ...
                logger.error(json.dumps({
                    "event": "scan_public_templates_error",
                    "error": str(e)
                }))
        ...
        for template in all_templates:
            ...
            if template_id not in template_dict or version > template_dict[template_id].get('version', 0):
